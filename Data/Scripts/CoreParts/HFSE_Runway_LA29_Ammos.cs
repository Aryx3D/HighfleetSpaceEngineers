...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef HFSE_LA29_FighterBomber => new AmmoDef 
        {
            ...
            {
                AmmoRound = "LA29 AC Ammo", // AmmoRound field of the ammo to spawn.
                ...
                TimedSpawns = new TimedSpawnDef // disables FragOnEnd in favor of info specified below
                {
                    ...
                    DirectAimCone = 35, //Aim cone used for Direct fire, in degrees
            ...
            Pattern = new PatternDef
            {
                Patterns = new[] { // If enabled, set of multiple ammos to fire in order instead of the main ammo.
                   "LA29 AC Ammo","LA29 AC Ammo","LA29 AC Ammo","LA29 AC Ammo","LA29 AC Ammo","LA29 AC Ammo","LA29 AC Ammo","LA29 AC Ammo","LA29 AC Ammo","LA29 AC Ammo"
                },
            ...
            {
                ModelName = "\\Models\\Highfleet\\HFSE_LA29_Subpart", // Model Path goes here. 
        ...
        private AmmoDef HFSE_LA29_Autocannon_Ammo => new AmmoDef
        {
            ...
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.001f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 200, // Direct damage; one steel plate is worth 100. 
            Mass = 5, // In kilograms; how much force the impact will apply to the target.
            Health = 100, // How much damage the projectile can take from other projectiles (base of 1 per hit) before dying; 0 disables this and makes the projectile untargetable.
