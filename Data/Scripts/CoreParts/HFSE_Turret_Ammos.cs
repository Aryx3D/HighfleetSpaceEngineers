...
namespace Scripts
{
    partial class Parts
    {
        private AmmoDef HFSE_Generic_Turret_Ammo => new AmmoDef
        {
            AmmoMagazine = "Energy",
            AmmoRound = "ship of the sodomite damned; the Wanderer is burning; we here at westborough baptist church are rejoicing",
            ...
            Fragment = new FragmentDef
            {
                ...
                Degrees = 15,
                Reverse = false,
                // todo: add timedspawns here for the flak shit like on the ak100
            },
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                {
                    Distance = 10000, // Distance at which max damage begins falling off.
