...
namespace Scripts
{
    partial class Parts
    {
        WeaponDefinition HFSE_Generic_Turret_Weapon => new WeaponDefinition {

            Assignments = new ModelAssignmentsDef 
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "YourSubtypeIDHere",
                        SpinPartId = "None",
            ...
            {
                PartName = "AK100 or some shit", // name of weapon in terminal
